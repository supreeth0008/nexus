...
def test_incident_state_machine():
    cases=[(IncidentStatus.detected,IncidentStatus.diagnosing,True),(IncidentStatus.detected,IncidentStatus.resolved,False),(IncidentStatus.verifying,IncidentStatus.resolved,True)]
